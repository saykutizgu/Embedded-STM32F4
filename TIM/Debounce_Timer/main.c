...
void INITIALIZE_HARDWARE(void){
	...
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 1;			// Priority Selections
	NVIC_InitStructure.NVIC_IRQChannelSubPriority = 1;                              // Timer Priority Should Be Higher In Order to Context Switch From EXTI Interrupt to TIM Interrupt
